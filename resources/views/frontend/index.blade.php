        ...
        <div class="swiper hero-swiper">
            <div class="swiper-wrapper hero-wrapper">
                @foreach($sliders as $slider)
                    <div class="swiper-slide hero-slider-one" style="background: url('{{ $slider->image_url }}')">
                        <div class="container">
                            <div class="col-lg-6">
                ...
                <div class="row gy-4 gx-5 gy-lg-0">
                    <div class="col-lg-6">
                        <div class="product-wrapper wrapper-one" data-aos="fade-right"
                             style="background: url('{{$first->image_url}}'); background-repeat: no-repeat; background-size: 100%;">
                            <div class="wrapper-info">
                                <span class="wrapper-subtitle">New Style</span>
                                <h4 class="wrapper-details">
                                    Get Bumper Offer
                                    <span class="wrapper-inner-title">& Make New</span>
                                    Fashion.
                                </h4>
...
<rect x="8" y="7.45703" width="9.25346" height="2.05632" transform="rotate(135 8 7.45703)"/>
                    ...
                    <div class="col-lg-6">
                        <div class="product-wrapper wrapper-two" data-aos="fade-up"
                             style="background: url('{{ $second->image_url ?? '' }}'); background-repeat: no-repeat; background-size: 100%;">
                            <div class="wrapper-info">
...
<path
    ...
    fill="#FFA800"/>
                                    ...
                                    <div class="product-description">
                                        ...
                                        <div class="price">
                                            @if($newArrival->discount_id !==null)
                                                <span
                                                    class="price-cut">{{(int)($newArrival->price * $newArrival->discount->rate /100) + $newArrival->price}}</span>
                                            @endif
                                ...
                                <div class="product-cart-btn">
                                    <a href="#" id="{{$newArrival->id}}" class="product-btn order-item"
                                       data-bs-toggle="modal" data-bs-target="#exampleModal">Get Order</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
                        ...
                        @foreach ($topSellings as $topSelling )
                            <div class="col-lg-4 col-md-6">
                                <div class="product-wrapper" data-aos="fade-right">
                                    <div class="product-img">
                                        <img src="{{ $topSelling->image_url }}" alt="{{ $topSelling->title }}">
                                        <div class="product-cart-items">
                ...
                fill="#FFA800"/>
                                        ...
                                        <div class="product-description">
                                            <a href="{{ route('product') }}"
                                               class="product-details">{{ $topSelling->title }}
                                            </a>
                                            <div class="price">
                                                <span class="new-price">{{ $topSelling->price }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product-cart-btn">
                                        <a href="#" class="product-btn">Get Order</a>
                                    </div>
                                </div>
                            </div>
