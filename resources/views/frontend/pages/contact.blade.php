...
<circle cx="22" cy="22" r="21.5" stroke="#AE1C9A">
                                                    ...
                                                    <div class="address-content">
                                                        ...
                                                        <p class="paragraph">{{$officeSetting->address}}</p>
                                                    </div>
                                                </div>
                                                <div class="contact-map">
                                                    <iframe src="{{$officeSetting->google_map}}" width="524" height="206" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="review-form">
                                ...
                                <div class=" account-inner-form">
                                    <div class="review-form-name">
                                        ...
                                        <input type="text" name="name" id="fname" class="form-control @error('name') is-invalid @enderror" placeholder="Name">
                                    </div>
                                    <div class="review-form-name">
                                        <label for="email" class="form-label">Email*</label>
                                        <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="user@gmail.com">
                                    </div>
                                    <div class="review-form-name">
                                ...
                                <div class="review-textarea">
                                    ...
                                    <textarea class="form-control @error('message') is-invalid @enderror" name="message" placeholder="Write Massage..........." id="floatingTextarea" rows="3"></textarea>
                                </div>
                                <div class="login-btn">
                                    <button type="submit" href="#" class="shop-btn">Send Now</button>
                                </div>
                                </form>
                            </div>
                        </div>
