        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between mt-2 mb-2">
                    ...
                    <a href="{{route('admin.product.discount.create')}}" class="btn btn-sm btn-outline-primary">
                ...
                <table class="table table-hover table-bordered align-middle">
                    ...
                    @forelse($discounts as $discount)
                        <tr>
                            ...
                            <td>{{$discount->rate}}</td>
                            <td class="d-flex">
                                <a href="{{route('admin.product.discount.edit', $discount)}}"
                                   class="btn btn-sm btn-outline-success me-1" title="Edit">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <form action="{{route('admin.product.discount.destroy',$discount)}}" method="post">
                                    @csrf
                                    @method('delete')
