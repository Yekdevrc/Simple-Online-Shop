        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between mt-2 mb-2">
                    ...
                    <a href="{{route('admin.website.slider.index')}}" class="btn btn-outline-primary">
                        <i class="fa-solid fa-list-check"></i>Slider List
                    </a>
                </div>
                <form action="{{route('admin.website.slider.update', $slider)}}" class="" method="post"
